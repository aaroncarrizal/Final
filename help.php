...
<body>
    ...
    <section class="container section scrollspy">
        <div class="row">
            <h1>Solicita ayuda personalizada a tu correo electrónico</h1>
        </div>
        <div class="row">
            <div class="col s12 m6 l6 offset-m3 offset-l3">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title center" style="margin-top: 2vw;"><i class="large material-icons">email</i>
                            <h3 style="margin-top: 0;">Solicitud de ayuda</h3>
                        </span>
                        <!--form-->
                        <form action="">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12 center">
                                    <button class="btn waves-effect  orange darken-2" type="submit" onclick="mensaje()">
                                        Solicitar ayuda <i class="material-icons right">send</i>
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        function mensaje(){
            alert('Este sito no soporta mensajes por email :(');
        };
    </script>
</body>
